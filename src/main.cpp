...
u-blox NINA-B3 Arduino example
Leonardo Bispo
March - 2019
https://github.com/ldab/Arduino-u-blox-NINA-B3

Distributed as-is; no warranty is given.

This example tries to implement some key functions and key PIN atributes in order
to get you started with using Arduino and the NRF52840 board u-blox NINA-B3
...
// pins below are accordingly to the EVK-NINA-B1 board https://www.u-blox.com/en/product/evk-nina-b3

#define NINA_RX       5   // P0.05 - GPIO23
#define NINA_TX       6   // P0.06 - GPIO22
#define NINA_SDA      16  // P0.16 - GPIO4
#define NINA_SCL      24  // P0.24 - GPIO5
//#define LED_DS1       7   // P0.07 - GPIO21
#define LED_RTS       31  // P0.31 - GPIO20
...
#define B_SW1         25  // P0.25 - GPIO7 - SWITCH 1 - *THIS PIN IS SHARED WITH RGB GREEN*
#define B_SW2         2   // P.02 - GPIO18 - SWITCH 2

// ********************************** BLE Stuff ******************************************************

const char * localName = "NINA-B3";
